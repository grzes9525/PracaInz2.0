...
public class DataProductLoader extends AppCompatActivity {
        ...
        try
        {
            ...
            while ((nextLine = reader.readLine()) != null) {
                ...
                if(nextLine.contains("%")){
                    ...
                    try {
                        product.setKcal(Double.valueOf(a.substring(0,a.indexOf("kcal"))));
                ...
                for(int i=0; i<nextLine.toCharArray().length;i++){
                    ...
                    if(b.matches(".*\\d+.*") && !nextLine.contains("%")){
                        ...
                        try{
                            product.setKcal(Double.valueOf(c.substring(0,c.indexOf("kcal"))));
